...
['p', 'A term can also be several words that name one idea, such as _network security_ ({{أمن الشبكات}}). Translate it as one unit.'],
...
['p', 'When you write a definition for your list, use one sentence: name the general group, then say what makes the term different. A _thermometer_ ({{مقياس الحرارة}}) is an instrument that measures temperature.'],
