...
['p', '_I have got the test in the bag_ is not about a bag: the speaker is sure of success. Arabic says this with a different picture. When a picture carries a different feeling in the other culture, keep the feeling. This is called **cultural approximation**, and it needs a good knowledge of both cultures.'],
...
['p', 'English has no exact word for {{الزكاة}}, and no identical custom. So you describe the meaning. This is called **descriptive translation**:'],
['ol', [
...
['p', 'Some cultural, religious, political or technical concepts have no equivalent, because the target language has a gap in its vocabulary. The translator then has to coin a word. This is called **lexical creation**.'],
...
['ol', [
  ...
  '**If none exists**, think like a terminologist and create an accurate one (Chapter 16). A good term is clear and short, has one meaning, and follows the language’s normal rules for making words.',
