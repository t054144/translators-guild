...
C = [
 ...
 ['table', ['Section or point', 'Status', 'Now in the handbook', 'What changed, and why'], [
  ['Three-step process: analysis of the source text, translation, post-translation activity', 'used as written', 'Ch 18, Step 1; Ch 25', 'Matches the three phases already in the handbook (analysis, translation and commentary).'],
  ['Model based on Fairclough’s relational model (Fairclough, 2003)', 'used and edited', 'Ch 18, Step 3; References', 'Fairclough (2003) added to the References and cited with the course materials.'],
  ['Two components: linguistic level and external level', 'used and edited', 'Ch 18, Step 3', 'Written as “look at two levels”.'],
  ['1.1.1 Lexical aspects', 'used and edited', 'Ch 18, Step 3', 'Given as “Words”, with the full list.'],
  ['1.1.2 Syntactical aspects', 'used and edited', 'Ch 18, Step 3', 'Given as “Grammar”; “cohesion” explained as how sentences are linked.'],
  ['1.1.3 Semantic level', 'used and edited', 'Ch 18, Step 3', 'Given as “Meaning”; speaker’s, sentence and figurative meaning left out to keep the list short; linked to Chapters 6 to 9.'],
  ['1.1.4 Morphological level', 'used and edited', 'Ch 18, Step 3', 'Given as “Word forms”. Reason for cuts: infixation, blending and clippings are too technical for beginners.'],
  ['1.1.5 Phonological level', 'used and edited', 'Ch 18, Step 3', 'Given as “Sound”, with where it matters most (poems, slogans, adverts).'],
  ['1.2.1 Textual level', 'used and edited', 'Ch 18, Step 3', 'Given as “The text”; texture and coherence left out; linked to Chapter 19.'],
  ['1.2.2 Intertextual level', 'used and edited', 'Ch 18, Step 3', 'Given as “Other texts” (quotations and allusions). Frame-modification, re-modelling and Al-ta’reed not used: too advanced.'],
  ['1.2.3 Political/ideological level', 'used and edited', 'Ch 18, Step 3', 'Given as “Point of view”, linked to Chapter 20.'],
  ['2. The external level', 'used and edited', 'Ch 18, Step 3', 'Given as three questions: background event, author, target culture and audience.'],
  ...
  ['Translation quality assessment', 'used and edited', 'Ch 18, Step 5', 'One sentence added: the model can also be used to judge a translation (Chapter 23).'],
 ...
 ['table', ['Request', 'Status', 'Now in the handbook', 'Note'], [
  ...
  ['From the Principles of Translation notes: English–Arabic communicative translation strategy', 'added', 'Ch 11, Step 4', 'Written from Newmark (1988, p. 47; page to be confirmed). To be compared with the notes.'],
  ['From the Principles of Translation notes: explicitation and implicitation', 'added', 'Ch 14, Step 3', 'Written from Vinay & Darbelnet (1958/1995, p. 342; page to be confirmed). Arabic terms {{التصريح}} and {{الإضمار}} to be confirmed.'],
