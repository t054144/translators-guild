...
['summary', ['**EN → AR**: prefer a verbal sentence, join short sentences, use Arabic punctuation.', '**AR → EN**: start with the subject, split long sentences, keep one of two synonyms, add “is”.', 'Use Modern Standard Arabic unless the client asks for a dialect.']],
...
['h', 'What is an idiom?'],
['p', '_It’s a piece of cake_ means “it is easy”. An idiom usually cannot be translated word by word. Use a target-language idiom with the same meaning, or translate its meaning in plain words (Baker, 2018).'],
